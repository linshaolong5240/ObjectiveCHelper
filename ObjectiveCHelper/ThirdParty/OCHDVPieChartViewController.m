...
@interface OCHDVPieChartViewController ()

@end

@implementation OCHDVPieChartViewController
...
- (void)viewDidLoad {
    ...
    DVPieChart *chart = [[DVPieChart alloc] initWithFrame:CGRectMake(0, 30, width, 196)];
